$(document).ready(function(){
	...
	$.post($url,{info:$data,type:$type},function(data){
		if(data) {
			...
			str+='<div class="title"><a target="_blank" href="'+link2+'?edu_recommend_adid=91">&#x76F8;&#x5173;&#x89C6;&#x9891;&#x8BFE;&#x7A0B;</a>';
			if(link2){
				str+='<a href="'+link2+'?edu_recommend_adid=91" target="_blank" style="float:right;">&#x66F4;&#x591A;</a>';
			}
