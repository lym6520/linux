...
{
	var unit_id     = "1001970";
	var client_ip   = "117.27.140.168";
	var server_time = "1377522554";
	var verify_code = "3deb01ff";
	var type        = "0";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	document.write( "<a href=\"http://"+icon_link_host+"/report.html?unit_id="+unit_id+"\" target=\"_blank\">&#37327;&#23376;&#32479;&#35745;</a>" );
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/1001970/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
