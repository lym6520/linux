...
{
	var unit_id     = "11613";
	var client_ip   = "114.80.182.162";
	var server_time = "1311136311";
	var verify_code = "d817db98";
	var type        = "0";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var icon_link_host="tongji.linezing.com";
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/11613/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
